...
class RotationPositions {
  ...
  static final Map<int, Map<Phase, Map<String, dynamic>>> positions = {
    ...
    3: {
      ...
      Phase.recepcio: {
        'Co': {'x': 0.9044435886150235, 'y': 0.7330087294600939},
        'R1': {'x': 0.3823035871478873, 'y': 0.21271640258215962},
        'C2': {'x': 0.22747487529342722, 'y': 0.4920407863849765},
        'O': {'x': 0.12731073943661972, 'y': 0.6308547901995305},
        'R2': {'x': 0.3423608054577465, 'y': 0.8205463248239436},
        'C1': {'x': 0.7443240170187794, 'y': 0.8408203125},
      },
      Phase.defensa: {
        'Co': {'x': 0.75, 'y': 0.75}, // At net (front right)
        'R1': {'x': 0.75, 'y': 0.25}, // Front left
